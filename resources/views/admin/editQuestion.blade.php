				...
				<div class="page-header">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold"> Edit Questions</span> - Question Management</h4>
						</div>
					</div>
...
<div class="panel panel-flat">
    ...
    <div class="panel-body">
        ...
        <form class="form-horizontal" action="{{url('/edit-question')}}" method="post">
            {{csrf_field()}}
            ...
            <fieldset class="content-group">
                ...
                <table  class="table table-hover small-text" id="tb">
                    ...
                    <tr>
                    <td><input type="text" name="option_text[]"  value="{{$options->option_text}}" class="form-control"></td>
                    <td><input type="text" name="option_value[]"  value="{{$options->option_point_value}}" class="form-control"></td>
